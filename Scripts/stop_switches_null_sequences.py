''' Stop switch analysis for null sequences. Considers stop codon flux at all positions regardless of frame. '''
...
def main():
    ...
    for root, dirs, filenames in os.walk(source):
        for f in filenames:
            ...
            if len(seq_list) == 3:
                ...
                #Get codons in all reading frames
                for i in range(len(in1)-2):
                    trinuc = in1[i:i+3]
                    in1_codons.append(trinuc)

                for i in range(len(in2)-2):
                    trinuc = in2[i:i+3]
                    in2_codons.append(trinuc)

                for i in range(len(out)-2):
                    trinuc = out[i:i+3]
                    out_codons.append(trinuc)
    ...
    filename = "Relative_switches.csv"
    subdir = "ncRNA/CSV"

...
source = './dinucleotide_matrix.tsv'
out_source = './dinuceotide_equilibria.csv'
...
def main():
    ...
    #Calculate mutuation frequencies
    ...
    headers = ['dinucleotide', 'equilibrium']
    ...
    #Bootstrap by resampling mutational events with replacement
    ...
    #Sample with replacement to obtain each boostrap, then recalculate equilibrium

    #Empty lists to store bootstrap results
    aa = []
    ac = []
    ag = []
    at = []
    ...
    print ('Dinucleotide', 'Estimate', 'Std')
    print ('AA:', aa_e, np.std(aa_eq))
    print ('AC:', ac_e, np.std(ac_eq))
    print ('AG:', ag_e, np.std(ag_eq))
    print ('AT:', at_e, np.std(at_eq))
    print ('CA:', ca_e, np.std(ca_eq))
    print ('CC:', cc_e, np.std(cc_eq))
    print ('CG:', cg_e, np.std(cg_eq))
    print ('CT:', ct_e, np.std(ct_eq))
    print ('GA:', ga_e, np.std(ga_eq))
    print ('GC:', gc_e, np.std(gc_eq))
    print ('GG:', gg_e, np.std(gg_eq))
    print ('GT:', gt_e, np.std(gt_eq))
    print ('TA:', ta_e, np.std(ta_eq))
    print ('TC:', tc_e, np.std(tc_eq))
    print ('TG:', tg_e, np.std(tg_eq))
    print ('TT:', tt_e, np.std(tt_eq))
    print ('GC content:', predicted_gc_e, np.std(gc_content))
